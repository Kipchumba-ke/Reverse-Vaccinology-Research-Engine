...
def calculate_pairwise_identity(
    ...
    identical_positions = sum(
        amino_acid_a == amino_acid_b
        for amino_acid_a, amino_acid_b
        in zip(sequence_a, sequence_b)
    )

    return (
        identical_positions / len(sequence_a)
    ) * 100
